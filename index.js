...
var version = "0.3.1" //A version the server reports using (If the client sees that it doesn't match this version, it will prompt you to update, unless the version check for that version is disabled or patched)
var port = 3000
