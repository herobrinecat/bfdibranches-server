...
var version = "0.3.6.1" //A version the server reports to the client (If the client sees that it doesn't match this version, it will prompt you to update, unless the version check for the client is patched)
var port = 3000
...
app.post("/sonicode.php", async (req, res) => {
    try {
